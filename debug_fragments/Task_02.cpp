...
Class for AVX512 read bandwidth test.
...
int Task_02::singleThreadScenario()
{
	LARGE_INTEGER hzPc;
	LARGE_INTEGER hzTsc;
	int exitCode = 0;
...
int Task_02::multiThreadScenario()
{
	LARGE_INTEGER hzPc;
	LARGE_INTEGER hzTsc;
	int exitCode = 0;
...
BOOL Task_02::measureTscClock(LARGE_INTEGER& hzPc, LARGE_INTEGER& hzTsc)
{
	BOOL status = FALSE;
	LARGE_INTEGER c1;
	LARGE_INTEGER c2;
...
void Task_02::threadFunction(void* ptr)
{
	DWORD64 deltaTsc = 0;
	readAvx512(ptr, COUNT, REPEATS, deltaTsc);
}
