...
Compute shader with flexible topology example.
...
constexpr UINT NUM_ARRAYS   = 2;                       // Two source arrays for sum. Read 2 source arrays and write 1 destination array. Read traffic analused.
constexpr UINT NUM_REPEATS  = 200;                     // Measurement repeats.
...
"{\r\n"
"BufferOut[DTid.x + DTid.y * STEP_Y + DTid.z * STEP_Z].i = Buffer0[DTid.x + DTid.y * STEP_Y + DTid.z * STEP_Z].i + Buffer1[DTid.x + DTid.y * STEP_Y + DTid.z * STEP_Z].i;\r\n"
"BufferOut[DTid.x + DTid.y * STEP_Y + DTid.z * STEP_Z].f = Buffer0[DTid.x + DTid.y * STEP_Y + DTid.z * STEP_Z].f + Buffer1[DTid.x + DTid.y * STEP_Y + DTid.z * STEP_Z].f;\r\n"
"}\0";
...
int main()
{
    std::cout << "Compute shader with flexible topology. v0.1.0." << std::endl;
