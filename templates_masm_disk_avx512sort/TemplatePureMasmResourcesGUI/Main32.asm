;
; GUI WINDOW WITH CLASSES. MENU RESOURCE DEMO. IA32 VERSION.
...
.DATA
className   DB  "Window class at MASM under Visual Studio 2022 (ia32)."        , 0
appName     DB  "Menu resource demo at MASM under Visual Studio 2022 (ia32)."  , 0
helloMsg    DB  "Menu resource demo at MASM under Visual Studio 2022 (ia32)."  , 0
...
@@:
mov [esi + WNDCLASSEX.lpszMenuName],IDR_MENU1            ; mov [esi + WNDCLASSEX.lpszMenuName],ebp
mov [esi + WNDCLASSEX.lpszClassName],offset className
push  IDI_ICON1                                          ;  push IDI_APPLICATION
push hInstance                                           ;  push ebp
call LoadIconA
