;
; GUI WINDOW WITH CLASSES. X64 VERSION.
...
.DATA
className   DB  "First class at MASM under Visual Studio 2022 (x64)."           , 0
appName     DB  "First GUI application at MASM under Visual Studio 2022 (x64)." , 0
helloMsg    DB  "First message at MASM under Visual Studio 2022 (x64)."         , 0
...
@@:
mov [rsi + WNDCLASSEX.lpszMenuName],rbp
