...
void TaskParms::resetBeforeParse()                     // Reset options (structure with command line parameters values) to defaults.
{
    ...
    p->optionModel = APPCONST::DEFAULT_MODEL;
    p->optionPattern = APPCONST::DEFAULT_PATTERN;
//  p->optionThreadCount = APPCONST::DEFAULT_THREAD_COUNT;
//  p->optionStartBlock = APPCONST::DEFAULT_START_BLOCK;
//  p->optionStopBlock = APPCONST::DEFAULT_STOP_BLOCK;
//  p->optionStep = APPCONST::DEFAULT_STEP;
...
const char* TaskParms::keysModel[] = { "singlethread", "multithread", nullptr };
const char* TaskParms::keysPattern[] = { "checknoaff", "checkaff", "readavx512", nullptr};
...
const OPTION_ENTRY TaskParms::options[] = {
    ...
    { "model"         , keysModel     , &parms.optionModel         , SELPARM } ,
    { "pattern"       , keysPattern   , &parms.optionPattern       , SELPARM } ,
//  { "threadcount"   , nullptr       , &parms.optionThreadCount   , INTPARM } ,
//  { "startblock"    , nullptr       , &parms.optionStartBlock    , MEMPARM } ,
//  { "stopblock"     , nullptr       , &parms.optionStopBlock     , MEMPARM } ,
//  { "step"          , nullptr       , &parms.optionStep          , MEMPARM } ,
