...
; This module connected for 32-bit build. See also asm64_v3.asm for 64-bit.
; 
...
_asmSortingPartitioned_v3@8 PROC
mov eax,0AAh
push ebx
kmovw k5,eax
push esi
...
pop ebx
ret 8
_asmSortingPartitioned_v3@8 ENDP
...
jle sortNetwork8
;- cmp eax,15
;- jle sortNetwork16   ; Sorting network X16 YET NOT SUPPORTED FOR IA32.
...
mov eax,[esp]
vmovsd xmm0,qword ptr [eax]    ; Note first iteration always match and skipped.
...
vbroadcastsd zmm1,qword ptr [eax]   ; XMM0[63-0] = Pivot value, and broadcast to ZMM.
vucomisd xmm0,xmm1
je skipPivot
vmovapd zmm0,zmm1
...
vmovupd xmm0,[ebx + esi * 8]
vshufpd ymm2,ymm0,ymm0,0001b
vminpd xmm4,xmm2,xmm0
vmaxpd xmm5,xmm2,xmm0
vmovapd xmm4{k5},xmm5
vmovupd [ebx + esi * 8],xmm4
ret
...
shr eax,cl
kmovw k4,eax
lea eax,[permuteConstants_v3]              ; TODO. Alignment 64 is better for this (VMOVAPD instead VMOVUPD).
vbroadcastsd ymm0,qword ptr [eax + 256]
vmovupd zmm6,[eax]
vmovupd zmm7,[eax + 64]
vmovupd ymm0{k4},[ebx + esi * 8]

vpermpd ymm2,ymm6,ymm0
vminpd ymm4,ymm2,ymm0
vmaxpd ymm5,ymm2,ymm0
vmovapd ymm4{k5},ymm5

vpermpd ymm2,ymm7,ymm4
...
;---------- END OF SPECIAL SUPPORT FOR N <= 8 SORTING NETWORK. ----------
...
permuteConstants_v3  dq  1,0,3,2,5,4,7,6
                     ...
                     dq  7,6,5,4,3,2,1,0
                     dq  2,3,0,1,6,7,4,5
plusInfConstant_v3   dq  07FF0000000000000h     ; +INF    ; OLD: ; qnanConstant_v3 dq 07FF8000000000001h
