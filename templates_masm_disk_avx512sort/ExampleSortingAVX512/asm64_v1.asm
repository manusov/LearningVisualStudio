...
; This module connected for 64-bit build. See also asm32_v1.asm for 32-bit.
; 
...
kmovw k7,eax
xor esi,esi
lea rax,[permuteConstants_v1]             ; TODO. Alignment 64 is better for this (VMOVAPD instead VMOVUPD).
lea edi,[edx - 1]
vmovupd zmm16,[rax]
...
; Plus, must not destroy ZMM16-ZMM19.                                                           ;
;-----------------------------------------------------------------------------------------------;
;--- asmPartitioning_v1 PROC ---
cmp edx,16
ja above16
mov r10,rcx
mov ecx,16
