...
; This module connected for 32-bit build. See also asm64_v2.asm for 64-bit.
; 
...
_asmSortingPartitioned_v2@8 PROC
mov eax,0AAh
push ebx
kmovw k5,eax
push esi
...
pop ebx
ret 8
_asmSortingPartitioned_v2@8 ENDP
...
shr eax,cl
kmovw k4,eax
lea eax,[permuteConstants_v2]              ; TODO. Alignment 64 is better for this (VMOVAPD instead VMOVUPD).
